...
class syntaxVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by syntaxParser#TypeDef.
    def visitTypeDef(self, ctx:syntaxParser.TypeDefContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by syntaxParser#VarTypeDef.
    def visitVarTypeDef(self, ctx:syntaxParser.VarTypeDefContext):
        return self.visitChildren(ctx)
